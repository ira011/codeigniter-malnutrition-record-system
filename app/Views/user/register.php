...
<head>
    ...
    <title>Register - Malnutrition Record System</title>
...
<body>
    <!-- Floating Graphics -->
    <!-- Same 35 floating fruits as the login page -->
    ...
    <script>
        // Ensure the body fade-in effect starts after the page has loaded
